                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                              ...
                              <div class="col-sm-7">
                                  <a href="addhandphone.php" class="btn btn-secondary"><span class="material-icons-outlined">Tambah Data</span></a>
                              </div>
                          </div>
                          </div>
                                    ...
                                    <tr>
                                          ...
                                          <td>
                                              <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-bottom:20px;margin-right:20px;">
                                                <a href="edithandphone.php?id=<?php echo $data->id;?>"><button class="btn btn-warning" style="margin-right: 10px;">Edit</button></a>
                                                <a href="deletehandphone.php?id=<?php echo $data->id;?>"><button class="btn btn-danger" onclick="return confirm('Yakin ingin hapus ?')">Delete</button></a>
                                              </div>
                                          </td>
                                    </tr>
                                <?php } ?>
